...
async function main() {
    try {
        ...
        if (process.argv.length > 2 && process.argv[2] === "--create-collections") {
            await createPhaseStats(new Date("2024-12-07T16:00:00.000Z"), new Date("2025-03-01T15:00:00.000Z"), "playerStatsAllPhases"); // End date should be end of latest phase
